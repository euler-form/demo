    ...
    <div data-options="region:'center'" style="background:#eee;">
        ...
        <div id="dlg" class="easyui-dialog dlg-window" style="width:400px;"
            ...
            <form id="fm" class="dlg-form" method="post">
                ...
                <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('user.empName')}</label><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true" id="dlg_empName" name="empName"></span></div>
                <div class="dlg-line hidden-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('user.enabled')}</label><span class="dlg-input-span"><input class="easyui-combobox dlg-input" data-options="panelHeight:'auto',panelMaxHeight:'200px',required:true" id="dlg_enabled" name="enabled"></span></div>
                <div class="dlg-line hidden-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('user.accountNonExpired')}</label><span class="dlg-input-span"><input class="easyui-combobox dlg-input" data-options="panelHeight:'auto',panelMaxHeight:'200px',required:true" id="dlg_accountNonExpired" name="accountNonExpired"></span></div>
                <div class="dlg-line hidden-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('user.accountNonLocked')}</label><span class="dlg-input-span"><input class="easyui-combobox dlg-input" data-options="panelHeight:'auto',panelMaxHeight:'200px',required:true" id="dlg_accountNonLocked" name="accountNonLocked"></span></div>
                <div class="dlg-line hidden-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('user.credentialsNonExpired')}</label><span class="dlg-input-span"><input class="easyui-combobox dlg-input" data-options="panelHeight:'auto',panelMaxHeight:'200px',required:true" id="dlg_credentialsNonExpired" name="credentialsNonExpired"></span></div>
            </form>
        </div>
    </div>
