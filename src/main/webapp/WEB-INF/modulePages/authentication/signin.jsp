...
<body>
    <div class="wrapper">
        ...
        <footer class="navbar navbar-inverse navbar-fixed-bottom footer-wrapper">Powered&nbsp;by&nbsp;EulerForm&nbsp;${eulerformVersion}&nbsp;&copy;<%=new SimpleDateFormat("yyyy").format(new Date()) %>&nbsp;cFrost&nbsp;<a id="icp" href="http://www.miitbeian.gov.cn" target="_Blank">粤ICP备15054669号</a></footer>
    </div>
