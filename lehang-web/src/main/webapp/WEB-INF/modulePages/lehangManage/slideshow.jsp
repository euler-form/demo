...
<body">
    <div id="dlg" class="easyui-dialog dlg-window" style="width:100%;"
        ...
        <form id="fm" class="dlg-form" enctype="multipart/form-data" method="post">
            <div class="dlg-line"><label class="dlg-label">${euler:i18n('slideshow.img')}1</label><span class="dlg-span"><img class="dlg-input img-box" id="dlg_img-show1" src="" alt="${euler:i18n('jsp.slideshow.pleaseUpload1600x600Img')}"></span></div>
            ...
            <br><br><br>
            <div class="dlg-line"><label class="dlg-label">${euler:i18n('slideshow.img')}2</label><span class="dlg-span"><img class="dlg-input img-box" id="dlg_img-show2" src="" alt="${euler:i18n('jsp.slideshow.pleaseUpload1600x600Img')}"></span></div>
            ...
            <br><br><br>
            <div class="dlg-line"><label class="dlg-label">${euler:i18n('slideshow.img')}3</label><span class="dlg-span"><img class="dlg-input img-box" id="dlg_img-show3" src="" alt="${euler:i18n('jsp.slideshow.pleaseUpload1600x600Img')}"></span></div>
