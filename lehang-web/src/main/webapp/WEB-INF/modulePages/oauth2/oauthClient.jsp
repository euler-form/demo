...
<body class="easyui-layout">
            ...
            <div id="client-setup-tab" class="easyui-tabs" data-options="collapsible:false" style="width:100%;height:100%;">
                <div title="${euler:i18n('jsp.client.basic')}" data-options="closable:false">
                    <form id="fm" class="dlg-form" method="post">
                        ...
                        <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('client.clientId')}</label><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true,prompt:'${euler:i18n('global.lettersOrNumbers')}'" id="dlg_clientId" name="clientId"></span></div>
                        <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('client.accessTokenValiditySeconds')}</label><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true,prompt:'${euler:i18n('jsp.client.neverExpires')}'" id="dlg_accessTokenValiditySeconds" name="accessTokenValiditySeconds"></span></div>
                        <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('client.refreshTokenValiditySeconds')}</label><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true,prompt:'${euler:i18n('jsp.client.neverExpires')}'" id="dlg_refreshTokenValiditySeconds" name="refreshTokenValiditySeconds"></span></div>
                        <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('client.neverNeedApprove')}</label><span class="dlg-input-span"><input class="easyui-combobox dlg-input" data-options="panelHeight:'auto',panelMaxHeight:'200px',required:true" id="dlg_neverNeedApprove" name="neverNeedApprove"></span></div>
                        <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('client.enabled')}</label><span class="dlg-input-span"><input class="easyui-combobox dlg-input" data-options="panelHeight:'auto',panelMaxHeight:'200px',required:true" id="dlg_enabled" name="enabled"></span></div>
                        <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('client.grantType')}</label><span class="dlg-span" style="text-align:left;"><label 
                        ...
                        <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('client.description')}</label><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="" id="dlg_description" name="description"></span></div>
                    </form>
                </div>
    ...
    <div id="client-redirect-uri-dlg" class="easyui-dialog" style="width:600px;"
        ...
        <form id="client-redirect-uri-fm" class="dlg-form" method="post">
            <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('jsp.client.redirectUri')}</label><span class="dlg-input-span"><input class="easyui-textbox dlg-input" style="width: 450px;" id="client-redirect-uri-dlg_newUri" name="newUri"></span></div>
        </form>
    </div>
